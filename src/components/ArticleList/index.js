...
const categories = [
  ...
  },
  {
    ...
    items: [
      ...
      { docId: 'agent-engineering/deployment', title: 'Agent 部署上线指南', description: 'Agent 部署与运维完整指南' },
      { docId: 'agent-engineering/project-development', title: 'Agent 实战项目开发', description: 'Agent 实战项目完整开发流程' },
    ],
  },
  {
    label: '⚡ 进阶能力',
